...
class Create: UIViewController {
    ...
    fileprivate let textFieldDel = TextDelegate()
...
extension Create: UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
extension Create: FontSelectorDelegate {
